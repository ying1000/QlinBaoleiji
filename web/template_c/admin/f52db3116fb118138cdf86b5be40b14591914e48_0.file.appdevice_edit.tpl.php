...
function setappaddress(value){
	...
	var afl = document.getElementById('autologinflag').options[document.getElementById('autologinflag').options.selectedIndex].attributes.autologinflag.nodeValue;
	...
	document.getElementById('oracle_sqlserver_port_tr').style.display='none';		
	document.getElementById('oracle_db_tr').style.display='none';		
	if(name=='ie'||name=='ie6'||name=='ie7'||name=='ie8'||name=='ie9'||name=='ie10'||name=='ie11'||appprogram[value].indexOf('iexplore.exe')>0){
		...
		if(name=='plsql'){		
			...
			document.getElementById('oracle_sqlserver_port_tr').style.display='';		
			document.getElementById('oracle_db_tr').style.display='';		
		}
	}else if(afl==36){
		document.getElementById('url').style.display='none';
		document.getElementById('mysqlport').style.display='';
		document.getElementById('sqlserverport').style.display='none';
	}else if(afl==37){
		document.getElementById('url').style.display='none';
		document.getElementById('mysqlport').style.display='none';
		document.getElementById('sqlserverport').style.display='';
	}
...
?>
AllServers[i]=new Array();
AllServers[i]['device_ip']='<?php echo $_smarty_tpl->tpl_vars['servers']->value[$_smarty_tpl->getVariable('smarty')->value['section']['kk']['index']]['device_ip'];?>
';
AllServers[i]['hostname']='<?php echo $_smarty_tpl->tpl_vars['servers']->value[$_smarty_tpl->getVariable('smarty')->value['section']['kk']['index']]['hostname'];?>
';
i++;
<?php endfor; endif; ?>
...
function filter(){
	...
	for(var i=0; i<AllServers.length;i++){
		if(filterStr.length==0 || AllServers[i]['device_ip'].indexOf(filterStr) >= 0 || AllServers[i]['hostname'].indexOf(filterStr) >= 0){
			appserver.options[appserver.options.length++] = new Option(AllServers[i]['device_ip']+'-'+AllServers[i]['hostname'],AllServers[i]['device_ip']);
		}
	}
}
...
" /></td>
	  ...
	  <tr <?php if ($_smarty_tpl->tpl_vars['trnumber']->value%2 == 0) {?>bgcolor="f7f7f7"<?php }?>>
		...
		<input type="text" class="wbk" size="10" id="filtertext" onChange="filter();" />
                  <select  class="wbk"  name="serverid" id="device_ip">
...
?>
							<option value="<?php echo $_smarty_tpl->tpl_vars['servers']->value[$_smarty_tpl->getVariable('smarty')->value['section']['k']['index']]['id'];?>
" <?php if ($_smarty_tpl->tpl_vars['servers']->value[$_smarty_tpl->getVariable('smarty')->value['section']['k']['index']]['device_ip'] == $_smarty_tpl->tpl_vars['p']->value['device_ip'] || $_smarty_tpl->tpl_vars['servers']->value[$_smarty_tpl->getVariable('smarty')->value['section']['k']['index']]['device_ip'] == $_smarty_tpl->tpl_vars['device_ip']->value || $_smarty_tpl->tpl_vars['servers']->value[$_smarty_tpl->getVariable('smarty')->value['section']['k']['index']]['hostname'] == $_smarty_tpl->tpl_vars['p']->value['device_ip']) {?>selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['servers']->value[$_smarty_tpl->getVariable('smarty')->value['section']['k']['index']]['device_ip'];?>
-<?php echo $_smarty_tpl->tpl_vars['servers']->value[$_smarty_tpl->getVariable('smarty')->value['section']['k']['index']]['hostname'];?>
</option>
						<?php endfor; endif; ?>
                  </SELECT>&nbsp;&nbsp;&nbsp;&nbsp;
                  	<select  class="wbk"  name="ishostname" id="ishostname">
						<option value="0" <?php if ($_smarty_tpl->tpl_vars['p']->value['ishostname'] == 0) {?>selected<?php }?>>IP连接</option>
						<option value="1" <?php if ($_smarty_tpl->tpl_vars['p']->value['ishostname'] == 1) {?>selected<?php }?>>域名连接</option>
		  			</select>
		</td>
	</tr>
...
" autologinflag="<?php echo $_smarty_tpl->tpl_vars['appprogram']->value[$_smarty_tpl->getVariable('smarty')->value['section']['p']['index']]['autologin'];?>
" id="program_<?php echo $_smarty_tpl->tpl_vars['appprogram']->value[$_smarty_tpl->getVariable('smarty')->value['section']['p']['index']]['name'];?>
" <?php if ($_smarty_tpl->tpl_vars['pp']->value['appprogramname'] == $_smarty_tpl->tpl_vars['appprogram']->value[$_smarty_tpl->getVariable('smarty')->value['section']['p']['index']]['name'] || $_smarty_tpl->tpl_vars['pp']->value['autologinflag'] == $_smarty_tpl->tpl_vars['appprogram']->value[$_smarty_tpl->getVariable('smarty')->value['section']['p']['index']]['autologin']) {?>selected<?php }?> ><?php echo $_smarty_tpl->tpl_vars['appprogram']->value[$_smarty_tpl->getVariable('smarty')->value['section']['p']['index']]['name'];?>
 </option>
			<?php endfor; endif; ?>
			</select>
		</td>
...
" /></td>
	  ...
	  <?php $_smarty_tpl->tpl_vars["trnumber"] = new Smarty_Variable($_smarty_tpl->tpl_vars['trnumber']->value+1, null, 0);?>
					<tr <?php if ($_smarty_tpl->tpl_vars['trnumber']->value%2 == 0) {?>bgcolor="f7f7f7"<?php }?> id="mysqlport" >
		<td width="10%" align=right>MySQL端口</td>
		<td><input type="text" size="100" name="navicat_port" value="<?php echo $_smarty_tpl->tpl_vars['p']->value['navicat_port'];?>
" /></td>
	  </tr>
	  <?php $_smarty_tpl->tpl_vars["trnumber"] = new Smarty_Variable($_smarty_tpl->tpl_vars['trnumber']->value+1, null, 0);?>
					<tr <?php if ($_smarty_tpl->tpl_vars['trnumber']->value%2 == 0) {?>bgcolor="f7f7f7"<?php }?> id="sqlserverport" >
		<td width="10%" align=right>SQL SERVER端口</td>
		<td><input type="text" size="100" name="sqlserver_port" value="<?php if ($_smarty_tpl->tpl_vars['p']->value['id']) {
echo $_smarty_tpl->tpl_vars['p']->value['sqlserver_port'];
} else { ?>1433<?php }?>" /></td>
	  </tr>
	   <?php $_smarty_tpl->tpl_vars["trnumber"] = new Smarty_Variable($_smarty_tpl->tpl_vars['trnumber']->value+1, null, 0);?>
...
" /></td>
	   ...
	   <?php $_smarty_tpl->tpl_vars["trnumber"] = new Smarty_Variable($_smarty_tpl->tpl_vars['trnumber']->value+1, null, 0);?>
					<tr <?php if ($_smarty_tpl->tpl_vars['trnumber']->value%2 == 0) {?>bgcolor="f7f7f7"<?php }?> id="oracle_db_tr" style="display:none">
		<td width="10%" align=right>Oracle Service_name</td>
		<td><input type="text" size="30" name="oracle_db" value="<?php echo $_smarty_tpl->tpl_vars['p']->value['oracle_db'];?>
" /></td>
	  </tr>
	   <?php $_smarty_tpl->tpl_vars["trnumber"] = new Smarty_Variable($_smarty_tpl->tpl_vars['trnumber']->value+1, null, 0);?>
					<tr <?php if ($_smarty_tpl->tpl_vars['trnumber']->value%2 == 0) {?>bgcolor="f7f7f7"<?php }?> id="oracle_sqlserver_port_tr" style="display:none">
		<td width="10%" align=right>oracle 端口</td>
		<td><input type="text" size="30" name="sqlserver_port1" value="<?php echo $_smarty_tpl->tpl_vars['p']->value['sqlserver_port'];?>
" /></td>
	  </tr>
	  <?php $_smarty_tpl->tpl_vars["trnumber"] = new Smarty_Variable($_smarty_tpl->tpl_vars['trnumber']->value+1, null, 0);?>
					<tr <?php if ($_smarty_tpl->tpl_vars['trnumber']->value%2 == 0) {?>bgcolor="f7f7f7"<?php }?>>
...
<?php if ($_smarty_tpl->tpl_vars['pp']->value['autologinflag'] == 36) {?>
	document.getElementById('mysqlport').style.display='';
	document.getElementById('url').style.display='none';
<?php } elseif ($_smarty_tpl->tpl_vars['pp']->value['autologinflag'] == 37) {?>
	document.getElementById('sqlserverport').style.display='';
	document.getElementById('url').style.display='none';
<?php }?>
}
