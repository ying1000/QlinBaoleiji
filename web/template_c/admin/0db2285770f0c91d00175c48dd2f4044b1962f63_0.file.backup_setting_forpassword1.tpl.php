<?php /* Smarty version 3.1.27, created on 2017-10-23 00:20:24
         compiled from "/opt/freesvr/web/htdocs/freesvr/audit/template/admin/backup_setting_forpassword1.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:38821358059ecc5489d7a53_96810891%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0db2285770f0c91d00175c48dd2f4044b1962f63' => 
    array (
      0 => '/opt/freesvr/web/htdocs/freesvr/audit/template/admin/backup_setting_forpassword1.tpl',
      1 => 1508689093,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '38821358059ecc5489d7a53_96810891',
  'variables' => 
  array (
    'title' => 0,
    'template_root' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_59ecc548a5a039_91982895',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_59ecc548a5a039_91982895')) {
function content_59ecc548a5a039_91982895 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '38821358059ecc5489d7a53_96810891';
?>
...
/images/an1.jpg" align="absmiddle"/><a href="admin.php?controller=admin_backup&action=backup_setting_forpassword">自动备份</a><img src="<?php echo $_smarty_tpl->tpl_vars['template_root']->value;?>
...
">
				  ...
				  <tr>
				  <th class="list_bg" >&nbsp;</th>
                    <th class="list_bg" ><a href = "admin.php?controller=admin_backup&action=backup_setting_forpassword&orderby1=desc&orderby2=<?php echo $_smarty_tpl->tpl_vars['orderby2']->value;?>
">描述</a></th>
                    <th class="list_bg" ><a href = "admin.php?controller=admin_backup&action=backup_setting_forpassword&orderby1=session_flag&orderby2=<?php echo $_smarty_tpl->tpl_vars['orderby2']->value;?>
">同步类型</a></th>
                    <th class="list_bg" ><a href = "admin.php?controller=admin_backup&action=backup_setting_forpassword&orderby1=ip&orderby2=<?php echo $_smarty_tpl->tpl_vars['orderby2']->value;?>
">同步地址</a></th>
                    <th class="list_bg" ><a href = "admin.php?controller=admin_backup&action=backup_setting_forpassword&orderby1=port&orderby2=<?php echo $_smarty_tpl->tpl_vars['orderby2']->value;?>
">同步端口</a></th>
                    <th class="list_bg" ><a href = "admin.php?controller=admin_backup&action=backup_setting_forpassword&orderby1=protocol&orderby2=<?php echo $_smarty_tpl->tpl_vars['orderby2']->value;?>
">同步协议</a></th>
...
/images/edit_ico.gif' width=16 height='16' hspace='5' border='0' align='absmiddle'><a href='admin.php?controller=admin_backup&action=backup_setting_forpassword_edit&id=<?php echo $_smarty_tpl->tpl_vars['alldev']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['seq'];?>
'>修改</a>
					 | <img src='<?php echo $_smarty_tpl->tpl_vars['template_root']->value;?>
/images/delete_ico.gif' width=16 height='16' hspace='5' border='0' align='absmiddle'><a href="#" onClick="if(!confirm('您确定要删除？')) {return false;} else { location.href='admin.php?controller=admin_backup&action=backup_setting_forpassword_del&id=<?php echo $_smarty_tpl->tpl_vars['alldev']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['seq'];?>
';}">删除</a>
				</td> 
			</tr>
			<?php endfor; endif; ?>
