<?php /* Smarty version 3.1.27, created on 2017-10-23 00:32:15
         compiled from "/opt/freesvr/web/htdocs/freesvr/audit/template/admin/pass_edit.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:104568335259ecc80f80f041_02631849%%*/
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '104568335259ecc80f80f041_02631849',
  'variables' => 
  array (
    'title' => 0,
    'template_root' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_59ecc80fa95612_14814847',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_59ecc80fa95612_14814847')) {
function content_59ecc80fa95612_14814847 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '104568335259ecc80f80f041_02631849';
?>
 ...
 <?php $_smarty_tpl->tpl_vars["trnumber"] = new Smarty_Variable($_smarty_tpl->tpl_vars['trnumber']->value+1, null, 0);?>
	...
	<tr <?php if ($_smarty_tpl->tpl_vars['trnumber']->value%2 == 0) {?>bgcolor="f7f7f7"<?php }?> id="forwardtr" >
		<TD width="20%" align=right>进向加速: </TD>
                  <TD width="80%"><INPUT id="fastpath_input" <?php if ($_smarty_tpl->tpl_vars['fastpath_input']->value == 1 || !$_smarty_tpl->tpl_vars['id']->value) {?> checked <?php }?> type=checkbox name=fastpath_input value="on">  
                </TR>    
				 <?php $_smarty_tpl->tpl_vars["trnumber"] = new Smarty_Variable($_smarty_tpl->tpl_vars['trnumber']->value+1, null, 0);?>
	<tr <?php if ($_smarty_tpl->tpl_vars['trnumber']->value%2 == 0) {?>bgcolor="f7f7f7"<?php }?> id="outforwardtr" >
		<TD width="20%" align=right>出向加速: </TD>
                  <TD width="80%"><INPUT id="fastpath_output" <?php if ($_smarty_tpl->tpl_vars['fastpath_output']->value == 1 || !$_smarty_tpl->tpl_vars['id']->value) {?> checked <?php }?> type=checkbox name=fastpath_output value="on">  
                </TR>    
