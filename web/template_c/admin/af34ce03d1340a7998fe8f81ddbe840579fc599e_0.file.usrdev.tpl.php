<?php /* Smarty version 3.1.27, created on 2017-10-23 00:20:18
         compiled from "/opt/freesvr/web/htdocs/freesvr/audit/template/admin/usrdev.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:114177660459ecc5427a94a0_79389740%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'af34ce03d1340a7998fe8f81ddbe840579fc599e' => 
    array (
      0 => '/opt/freesvr/web/htdocs/freesvr/audit/template/admin/usrdev.tpl',
      1 => 1508689104,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '114177660459ecc5427a94a0_79389740',
  'variables' => 
  array (
    'title' => 0,
    'template_root' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_59ecc542be40f1_76159051',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_59ecc542be40f1_76159051')) {
function content_59ecc542be40f1_76159051 ($_smarty_tpl) {
...
$_smarty_tpl->properties['nocache_hash'] = '114177660459ecc5427a94a0_79389740';
?>
...
<?php }?>&nbsp;<input type="submit" height="35" align="middle" value=" 确定 " border="0" class="bnnew2"/><?php if ($_SESSION['ADMIN_LEVEL'] == 0) {
if ($_smarty_tpl->tpl_vars['logintype']->value != 'apppub' && $_smarty_tpl->tpl_vars['logintype']->value != '_apppub') {?>&nbsp;磁盘映射:<input type="checkbox" name="rdpdiskauth_" id="rdpdiskauth_" <?php if (!$_smarty_tpl->tpl_vars['member']->value['rdpdiskauth_up']) {?>disabled<?php }?> <?php if ($_smarty_tpl->tpl_vars['rdpdiskauth_up']->value) {?>checked<?php }?> value="1"  />&nbsp;剪切版:<input type="checkbox" name="rdpclipauth_" id="rdpclipauth_" <?php if (!$_smarty_tpl->tpl_vars['member']->value['rdpclipauth_up']) {?>disabled<?php }?>  onclick="checkieNT52(this)" <?php if ($_smarty_tpl->tpl_vars['member']->value['rdpclipauth_up']) {?>checked<?php }?> value="1"  />&nbsp;本地:<input type="checkbox" name="consoleauth_" id="consoleauth_" <?php if (!$_smarty_tpl->tpl_vars['member']->value['rdplocal']) {?>disabled<?php } else {
if ($_smarty_tpl->tpl_vars['member']->value['rdplocalcheck']) {?>checked<?php }
					...
					域名连接:<input type="checkbox" name="bydomain" id="bydomain" <?php if ($_smarty_tpl->tpl_vars['bydomain']->value) {?>checked<?php }?> value="1"  />&nbsp;外网NAT IP:<input type="checkbox" name="outsideip" id="outsideip" <?php if ($_smarty_tpl->tpl_vars['outsideip']->value) {?>checked<?php }?> value="1"  />&nbsp;
					<?php }?>			
</form>
	  </td>
  </tr>
...
/images/flashfxp_icon.png" title="FLASHXP" border=0></a>&nbsp;&nbsp;&nbsp;
					<a id="d<?php echo $_smarty_tpl->tpl_vars['alldev']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['id'];?>
" href='admin.php?controller=admin_pro&action=dev_login&logintool=filezilla&id=<?php echo $_smarty_tpl->tpl_vars['alldev']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['id'];?>
'  onclick="return goto3(this.id)" target="hide"><img width="16" height="16" src="<?php echo $_smarty_tpl->tpl_vars['template_root']->value;?>
/images/filezilla.png" title="FileZilla" border=0></a>
					<?php } else { ?>
					<img src="<?php echo $_smarty_tpl->tpl_vars['template_root']->value;?>
...
" href='admin.php?controller=admin_pro&action=dev_login&logintool=flashxp&id=<?php echo $_smarty_tpl->tpl_vars['alldev']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['id'];?>
'  onclick="return goto3(this.id)" target="hide"><img src="<?php echo $_smarty_tpl->tpl_vars['template_root']->value;?>
/images/flashfxp_icon.png" title="FLASHXP" border=0></a>&nbsp;&nbsp;&nbsp;<a id="d<?php echo $_smarty_tpl->tpl_vars['alldev']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['id'];?>
" href='admin.php?controller=admin_pro&action=dev_login&logintool=filezilla&id=<?php echo $_smarty_tpl->tpl_vars['alldev']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['id'];?>
'  onclick="return goto3(this.id)" target="hide"><img width="16" height="16" src="<?php echo $_smarty_tpl->tpl_vars['template_root']->value;?>
/images/filezilla.png" title="FileZilla" border=0></a>
					<?php } else { ?>
...
/images/windows.jpg"  width=16 height='16' ></a>&nbsp;&nbsp;&nbsp;&nbsp;<a id="a_<?php echo $_smarty_tpl->tpl_vars['alldev']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['id'];?>
_pubclddsk"  href="#" title="公有云盘" onclick="return rdpgofolder(<?php echo $_smarty_tpl->tpl_vars['alldev']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['id'];?>
, 'pubclddsk');" target="_blank"><img  src="<?php echo $_smarty_tpl->tpl_vars['template_root']->value;?>
/images/1_1.jpg"  width=16 height='16' ></a>&nbsp;&nbsp;&nbsp;&nbsp;<a id="a_<?php echo $_smarty_tpl->tpl_vars['alldev']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['id'];?>
_priclddsk"  href="#" title="私有云盘" onclick="return rdpgofolder(<?php echo $_smarty_tpl->tpl_vars['alldev']->value[$_smarty_tpl->getVariable('smarty')->value['section']['t']['index']]['id'];?>
, 'priclddsk');" target="_blank"><img  src="<?php echo $_smarty_tpl->tpl_vars['template_root']->value;?>
/images/1-1.png"  width=16 height='16' ></a></td>
			</tr>
			<?php endfor; endif; ?>
			<?php }?>
			<?php if (isset($_smarty_tpl->tpl_vars['smarty']->value['section']['tt'])) unset($_smarty_tpl->tpl_vars['smarty']->value['section']['tt']);
	...
	for(var i=0; i<elms.length; i++){
		if(elms[i].name.substring(0,7)=='session'&&elms[i].checked){
			...
			if(args[0]=='RDP'){
				...
				var outsideip = document.getElementById('outsideip').checked ? '1' : '0';
				url='admin.php?controller=admin_pro&action=dev_login&id='+args[1]+'&screen='+fenbian+'&selectedip='+lbip+'&app_act='+app_act+'&rdparg=0&appdeviceid=0&rdpclipauth='+rdpclipauth+'&rdpdiskauth='+rdpdiskauth+'&bydomain='+bydomain+'&outsideip='+outsideip;
...
"+'&selectedip='+lbip+'&app_act='+app_act+'&bydomain='+bydomain+'&outsideip='+outsideip+'&'+Math.round(new Date().getTime()/1000);
			}
...
function rdpgo(iid,appdeviceid,isrdp){	
	...
	var weburl='admin.php?controller=admin_pro&action=dev_login&id='+iid+'&selectedip='+lbip<?php if (!($_smarty_tpl->tpl_vars['logintype']->value == 'apppub' || $_smarty_tpl->tpl_vars['logintype']->value == '_apppub')) {?>+'&screen='+fenbian+'&app_act='+app_act+'&rdpclipauth='+rdpclipauth+'&rdpdiskauth='+rdpdiskauth<?php }?>+'&rdparg=0&appdeviceid='+appdeviceid+'&bydomain='+bydomain+'&outsideip='+outsideip;
	if(isrdp){
...
function rdpgo2(iid,appdeviceid,isrdp){
	...
	document.getElementById(aid).href='admin.php?controller=admin_pro&rdptype=activex&action=dev_login&id='+iid+'&selectedip='+lbip+'&rdparg=0&appdeviceid='+appdeviceid<?php if (!($_smarty_tpl->tpl_vars['logintype']->value == 'apppub' || $_smarty_tpl->tpl_vars['logintype']->value == '_apppub')) {?>+'&screen='+fenbian+'&app_act='+app_act+'&rdpclipauth='+rdpclipauth+'&rdpdiskauth='+rdpdiskauth<?php }?>+'&bydomain='+bydomain+'&outsideip='+outsideip;
	if(isrdp){
...
function rdpgofolder(iid,t){
	...
	var url='admin.php?controller=admin_pro&action=dev_login&folder='+t+'&id='+iid+'&selectedip='+lbip+'&rdparg=0&appdeviceid=0'<?php if (!($_smarty_tpl->tpl_vars['logintype']->value == 'apppub' || $_smarty_tpl->tpl_vars['logintype']->value == '_apppub')) {?>+'&screen='+fenbian+'&app_act='+app_act+'&rdpclipauth='+rdpclipauth+'&rdpdiskauth='+rdpdiskauth<?php }?>+'&bydomain='+bydomain+'&outsideip='+outsideip;
...
function goto3(iid){
	...
	var bydomain = document.getElementById('bydomain').checked ? '1' : '0';
	var outsideip = document.getElementById('outsideip').checked ? '1' : '0';
	var url =document.getElementById(iid).href+'&selectedip='+lbip+'&app_act='+app_act+'&bydomain='+bydomain+'&outsideip='+outsideip+'&'+Math.round(new Date().getTime()/1000);
	$.get(url, {Action:"get",Name:"lulu"}, function (data, textStatus){
		this; // 在这里this指向的是Ajax请求的选项配置信息，请参考下图
		if(data.substring(0,<?php if ($_SESSION['urlprotocol'] == 1) {?>11<?php } else { ?>10<?php }?>)=='<?php if ($_SESSION['urlprotocol'] == 1) {?>baoleiji<?php } else { ?>freesvr<?php }?>://'){
			launcher(data);
