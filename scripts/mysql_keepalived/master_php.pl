...
our($peer_ip,$local_ip,$interface,$virtual_ip) = ("172.16.210.61", "172.16.210.62", undef, undef);
#our($peer_ip,$local_ip,$interface,$virtual_ip) = ("172.16.210.61", "172.16.210.62", "eth0", "172.16.210.63");
our $mycnf_path = "/opt/freesvr/1/etc";
our $user = "root";
our $user_home_dir = "/root";
our $passwd="blj2015BLJ1";
